  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-6xl mx-auto pb-24 md:pb-8">
      ...
      <section className="mt-6 card p-5">
        <h2 className="text-sm font-medium mb-3">Top from-numbers (7d)</h2>
            ...
            {stats.byNumber.map((n) => (
              ...
              >
                <span className="font-mono text-xs sm:text-sm truncate">
                  {fmtPhone(n.fromNumber)}
                </span>
                <div className="flex items-center gap-3 text-xs text-muted shrink-0">
                  <span className="tabular-nums">
                    <PhoneCall size={11} className="inline mr-0.5 -mt-0.5" />
                    {n.count}
                  </span>
                  <span className="tabular-nums">
                    <Clock size={11} className="inline mr-0.5 -mt-0.5" />
                    {fmtDuration(n.totalDuration)}
                  </span>
                </div>
              </div>
            ))}
...
function DailyTrend({
  ...
  if (rows.length === 0) {
    return (
      <p className="text-xs text-muted mt-2">No calls in the last 7 days.</p>
    );
  }
